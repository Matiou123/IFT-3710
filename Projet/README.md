...
- analyse_projet.py prend un fichier .csv de cristaux généré par gflownet puis renvoit un graphique avec 3 sous-graphiques et calcul la densité moyenne et son écat-type

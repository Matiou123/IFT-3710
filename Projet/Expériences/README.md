...
``` 
Après l'entraînement, un dossier du modèle devrait être créé qui devrait se trouver dans `gflownet/logs/crystalgfn/local/`. Le nom du dossier devrait être un type  *timestemp*, par exemple `/2026-04-07_18-17-05_985445`. Il faut utiliser ce dossier pour l'échantillonage. Il faut passer cette commande à la racine de `glownet` pour échantilloner
```sh
